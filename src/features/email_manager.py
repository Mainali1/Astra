...
class EmailManager:
    ...
    async def send_email(self, to: str, subject: str, body: str, html: bool = False) -> bool:
        ...
        try:
            ...
            # Cache sent email
            sent_email = {"to": to, "subject": subject, "timestamp": datetime.now().isoformat(), "success": True}
    ...
    def get_email_history(self, sent: bool = True, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            return sorted(history, key=lambda x: x["timestamp"] if sent else x["date"], reverse=True)[:limit]
        except Exception as e:
