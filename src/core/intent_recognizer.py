...
class IntentRecognizer:
    ...
    def __init__(self):
        ...
        self.patterns: Dict[str, List[Dict[str, Any]]] = {
            ...
            "reminder": [
                ...
                {
                    "pattern": r"set (?:a|an) (?:reminder|alarm) (?:for|to) (?P<task>.+) (?:in|at) (?P<time>.+)",
                    "action": "set_reminder",
                },
            ],
            "todo": [
    ...
    def add_pattern(self, feature: str, pattern: str, action: str):
        ...
        pattern_dict = {"pattern": pattern, "action": action, "compiled": re.compile(pattern, re.IGNORECASE)}
    ...
    def remove_pattern(self, feature: str, pattern: str):
        ...
        if feature in self.patterns:
            self.patterns[feature] = [p for p in self.patterns[feature] if p["pattern"] != pattern]
